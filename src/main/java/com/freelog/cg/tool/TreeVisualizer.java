...
public class TreeVisualizer {
    ...
    public static Parser getParserOfService (String contractServiceName) {
        String grammarName = contractServiceName+"Policy";
        Parser parser = null;
    ...
    public static Lexer getLexerOfService(String contractServiceName) {
        String grammarName = contractServiceName+"Policy";
        Lexer lexer = null;
    ...
    public static Class<? extends Parser> getParserClass (String serviceName) throws ClassNotFoundException {
        return  TreeVisualizer.class.getClassLoader().loadClass(serviceName+"Parser").asSubclass(Parser.class);
    }
